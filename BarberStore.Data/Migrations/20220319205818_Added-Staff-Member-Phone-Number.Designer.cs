...
namespace BarberStore.Infrastructure.Migrations
{
    ...
    [Migration("20220319205818_Added-Staff-Member-Phone-Number")]
    partial class AddedStaffMemberPhoneNumber
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("BarberStore.Infrastructure.Data.Models.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BarberStore.Infrastructure.Data.Models.Product", null)
                        .WithMany()
